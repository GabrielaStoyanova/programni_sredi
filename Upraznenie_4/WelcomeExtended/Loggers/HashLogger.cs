...
namespace WelcomeExtended.Loggers
{
    public class HashLogger : ILogger
    {
        ...
        // Method to retrieve all recorded messages => FIRST TASK
        public string[] GetRecordedMessages()
        {
            return _logMessages.Values.ToArray();
        }

        // Method to print event on a given eventId => SECOND TASK
        ...
        // Method to delete event by given eventId => THIRD TASK
